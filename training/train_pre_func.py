...
def def_losses():
    ...
    temporal_loss = Temporal_Consistency_Loss().cuda()
    motion_loss = Motion_Loss().cuda()
...
def make_loss_dict(discriminate_loss, intensity_loss, gradient_loss,
                   adversarial_loss, flow_loss, motion_loss, temporal_loss, bezier_loss):
